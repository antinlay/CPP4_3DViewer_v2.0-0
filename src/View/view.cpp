...
View::View(QWidget *parent) : QMainWindow(parent), ui(new Ui::View) {
  ...
  //    QString styleSheet = "QWidget { background-image:
  //    url(/Users/janiecee/Documents/CPP4_3DViewer_v2.0-0/src/imgMenu.png); }";
...
void View::openFile() {
  QString fileName = QFileDialog::getOpenFileName(
      this, "Choose file", QDir::fromNativeSeparators("../../../../Obj"),
      "Oblect files (*.obj)");
  if (!fileName.isEmpty()) {
    qDebug() << fileName;
